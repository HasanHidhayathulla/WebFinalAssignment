...
// Get all members
$members = [];
$sql = "SELECT member_id, first_name, last_name, birthday, email FROM member ORDER BY member_id ASC";
...
<body>
    <div class="container">
        ...
        <div id="formSection" class="form-section" style="<?php echo !$show_form ? 'display: none;' : ''; ?>">
            ...
            <form method="POST" action="library_members_handler.php">
                <?php if ($edit_member): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="library_members.php?edit=<?php echo htmlspecialchars($member['member_id']); ?>" 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="library_members_delete.php" id="deleteForm" style="display: inline;">
